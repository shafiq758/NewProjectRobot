...
Add FTP User
   ...
   run keyword if   '${toggle_status}'=="off"    run keywords  
    ...
    ...   AND    sleep    5s    
    ...   AND    Should DIsplay Flash Message    FTP service has been enabled.
   Click ELement    xpath=/html/body/main/segment[2]/actions/a/ico
...
Create Log Receiver Rule
   ...
   Click Element     xpath=/html/body/aside/aside-wide/aside-menu[1]/aside-menuitems/a[@href="/SYSTEM/logreceiver/index"]/aside-menuitem
   Click Element   xpath=/html/body/main/section/info/a/ico
   Wait Until Element Is Visible    id=rule_name     5s
   Input Text    id=rule_name    ${LogRuleName}
   Click Element  id=driver-tcp
   Input Text   name=port   ${LogRulePort}
   Input Text   id=path     ${LogRulePath}
   Click Button   Add
   Should Display Flash Message   Rule has been created successfully.
...
Navigate to Setting 
   #Log To Console  ${ip}   #For Validation Purpose
...
Enable And Input In Login Banner 
   ...
   Navigate to Setting
   Click Element    xpath=/html/body/aside/aside-wide/aside-menu[5]/aside-menuitems/a[4]/aside-menuitem
   sleep    5s
...
Validate Splunk Web Enabled
   ...
   #Log To Console   ${toggle_status}    #For Validation Purpose
   run keyword if   '${toggle_status}'=="off"    run keywords  
...
Upload gemini-appliance-889.patch
   [Documentation]  To Upload Appliance Pack
   Capture Page Screenshot
   Execute JavaScript    document.getElementById('upgrade_pack').style.display = 'block'
   choose file    id=upgrade_pack       ${CURDIR}/2.2.3to2.3/${appliancePatch}
   Capture Page Screenshot
   Wait Until Element Is Visible    id=btn_upload    5s
   Click Button    Upload    
   Capture Page Screenshot
   Wait Until Element Is Visible    id=btn_upgrade    50s
...
Upload Upgrade Pack
   ...
   Click Button    Upload 
   Capture Page Screenshot
   Wait Until Element Is Visible       id=btn_upgrade    30m
   Capture Page Screenshot
   sleep    5s
   Click Element    id=btn_upgrade
   Sleep    10m
   Capture Page Screenshot
   Reload Page
   Sleep    10m 
   ...
   Navigate to Setting
   Sleep    5s
   Element Text Should Be     xpath=/html/body/page/main/segment[1]/article/p/bold          ${afterUpgrade}
...
Validate Netowrk Settings
   ...
   Click ELement    xpath=/html/body/aside/aside-wide/aside-menu[1]/aside-menuitems/a[@href="/SYSTEM/ethernet/index"]/aside-menuitem
   sleep    5s
   ${text}     Get Text     xpath=/html/body/page/main
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=/html/body/page/main   ${DNSServer}

Validate NTP Server 
   [Documentation]    Validate NTP Added Server after Upgrade
   Navigate To Node
   Sleep   7s
   ${text}     Get Text       xpath=/html/body/main
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=/html/body/main   ${ServerName}
...
Validate Time Stamp 
   ...
   #Log To Console     ${text}   #For Validation Purpose
   ${text1}   Get Value    xpath=/html/body/main/section/form/form-row[8]/selectwrapper/select
   #Log To Console     ${text1}    #For Validation Purpose
...
Validate SNMP Setting 
   ...
   ${text}   Get Text    xpath=/html/body/page/main
   #Log To Console     ${text}     #For Validation Purpose
   Element Should Contain  xpath=/html/body/page/main   ${SNMPAgentName}
   Element Should Contain  xpath=/html/body/page/main   2c
...
Validate FTP Settings 
   ...
   ${text}   Get Text    xpath=/html/body/main
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=/html/body/main   ${FTPUsername}
   #Element Should Contain  xpath=/html/body/main   /opt/sbox
...
Validate SSH Settings
   ...
   Sleep  5s
   Click Element     xpath=/html/body/aside/aside-wide/aside-menu[1]/aside-menuitems/a[@href="/SYSTEM/ssh/index"]/aside-menuitem  
   ${text}    Get Value    xpath=/html/body/main/section/form/form-row[1]/input
   #Log To Console     ${text}    #For Validation Purpose
...
Validate SNMP Trap Destination
   ...
   ${text}    Get Text    xpath=/html/body/page/main
   #Log To Console     ${text}   #For Validation Purpose
   Element Should Contain  xpath=/html/body/page/main   ${TrapIp}
   Element Should Contain  xpath=/html/body/page/main   ${TrapCommunity}
   Element Should Contain  xpath=/html/body/page/main   ${TrapPort}
...
Validate Log Receiver Rule
   ...
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=//*[@id="rule-wrap-f757b2"]   ${LogRuleName}
...
Validate Admin Forwarding Rule
   ...
   ${text}    Get Text    xpath=/html/body/page/main
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=/html/body/page/main  ${AdminRuleName}
   Element Should Contain  xpath=/html/body/page/main  file
   Element Should Contain  xpath=/html/body/page/main  /opt/sbox/data/${AdminRulePath}
...
Cluster Settings 
   ...
   ${text}    Get Text    xpath=/html/body/main
   #Log To Console     ${text}    #For Validation Purpose
   Element Should Contain  xpath=/html/body/main  ${NodeGroupName}       
   Element Should Contain  xpath=/html/body/main  2
...
Job Settings 
   ...
   ${text}    Get Text    xpath=/html/body/main
   #Log To Console     ${text}     #For Validation Purpose
     Element Should Contain  xpath=/html/body/main  ${JobName}
     #Element Should Contain  xpath=/html/body/main  ALL NODES
     #Element Should Contain  xpath=/html/body/main  Get current timezone
...
Validate Login Banner
   [Documentation]   To validate Login Banner after Upgrade
    Navigate to Setting   
    sleep   5s 
    Click Element    xpath=/html/body/aside/aside-wide/aside-menu[5]/aside-menuitems/a[5]/aside-menuitem
    sleep    5s
    ${xpath_combined}=    Set Variable     //*[@class="off"]
    ${count}=    Get Matching Xpath Count    ${xpath_combined} 
    Log    Num value is ${count}
   ...
   Element Should Contain  xpath=/html/body/main  ${content}
